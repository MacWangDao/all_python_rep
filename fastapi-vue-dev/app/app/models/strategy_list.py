...
class User(Base):
    __tablename__ = "T_W_BJHY_STOCK_LIST"
    stoid = Column(Integer, Sequence(__tablename__ + '_ID_SEQ', start=1, increment=1), primary_key=True)
    stname = Column(String(255), nullable=False)
    ...
    cstodatetime = Column(DateTime, nullable=True)
