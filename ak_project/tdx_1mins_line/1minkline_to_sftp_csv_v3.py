...
logger.add("1minkline_to_sftp_csv_v3.log", rotation="100MB", encoding="utf-8", enqueue=True,
...
class DailyMinkLineToCsv(object):
    def __init__(self, config_path: str = "config_sftp_csv_v3.ini"):
        try:
            self.df_list = []
            logger.info("config_sftp_csv_v3.ini")
