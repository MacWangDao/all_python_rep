...
logger.add("log/hkexnews.log", rotation="100MB", encoding="utf-8", enqueue=True,
...
@scheduler.scheduled_job("cron", day_of_week="0-5", hour=6, minute="5,10", second=3, misfire_grace_time=10,
                         max_instances=10,
                         id='spider_hk_03')
def spider_hk_job_third():
    asyncio.run(main())


if __name__ == "__main__":
    # asyncio.run(main(tradedate="20230411"))
    logger.info("spider_hk_server...")
